        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- ②【立体ノックボタン（後端）】ペン軸の右上からカチッと一段細く飛び出しているパーツ -->
                    <path d="M 18.2 5.0 L 19.5 2.8 L 21.2 3.8 L 19.9 6.0 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン本体の白抜きアウトライン】約60度の急な傾きで長く伸ばし、中を綺麗に白抜き透過 -->
                    <path d="M 13.0 18.0 L 11.0 15.0 L 17.5 5.5 L 19.5 7.5 L 14.5 16.0 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の鋭利な三角錐（チップ）】チョークに見えないよう、最先端(13,18)に向けてシャープに絞るV字線 -->
                    <path d="M 11.0 15.0 L 14.5 16.0" stroke="#222222"></path>
                    
                    <!-- ⑤【ペンの後端（キャップ境界線）】本体とノックボタンのつなぎ目を表現する斜めのディテール線 -->
                    <path d="M 17.5 5.5 L 19.5 7.5" stroke="#222222"></path>
                </svg>
            `;
        }
