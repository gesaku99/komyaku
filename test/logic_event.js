        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    <!-- ①左上(5,4)から下部余白(5,21)へ下ろし、右へ(12,21)まで引いた太さ2.3の境界線 -->
                    <path d="M 5.00 4.00 L 5.00 21.00 L 12.00 21.00" stroke-width="2.3"></path>
                    
                    <!-- ②【立体ノックボタン（後端）】胴体の中心軸から60度方向へ真っ直ぐ1.25px幅で突き出す完全対称パーツ -->
                    <path d="M 17.00 8.32 L 18.25 6.15 L 19.12 6.65 L 17.87 8.82 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完璧な長方形）】対辺が完全に平行で、1ミリの折れ曲がりもない透過白抜きボディ -->
                    <path d="M 10.00 17.54 L 15.50 8.01 L 19.50 10.32 L 14.00 17.54 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】最先端(12,21)が境界線の端点(12,21)へ完璧にのるシャープチップ -->
                    <path d="M 10.00 17.54 L 12.00 21.00 L 14.00 17.54 Z" fill="#ffffff"></path>
                    
                    <!-- ⑤【先端チップと胴体の境界線 ──> 後端ノック境界線】美しい対称ディテール線 -->
                    <path d="M 10.00 17.54 L 14.00 17.54 M 15.50 8.01 L 19.50 10.32" stroke="#222222"></path>
                </svg>
            `;
        }
