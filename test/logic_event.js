        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    <!-- ①左上(5.00, 4.00)から下部余白(5.00, 21.00)へ下ろし、右へ(12.00, 21.00)まで引いた太さ2.30の境界線 -->
                    <path d="M 5.00 4.00 L 5.00 21.00 L 12.00 21.00" stroke-width="2.30"></path>
                    
                    <!-- ②【立体ノックボタン（後端）】長方形の短辺中央（中心軸上）から完璧に60度方向へ突き出す同軸パーツ -->
                    <path d="M 17.27 4.41 L 18.52 2.25 L 19.38 2.75 L 18.13 4.91 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完璧な長方形）】対辺が完全に平行（Δx=6.00, Δy=-10.39）な透過白抜きボディ -->
                    <path d="M 10.27 16.54 L 16.27 6.15 L 19.73 4.15 L 13.73 14.54 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】最先端(12.00, 21.00)が、胴体短辺の底辺から1ミリの歪みもなく対称に尖るシャープチップ -->
                    <path d="M 10.27 16.54 L 12.00 21.00 L 13.73 14.54 Z" fill="#ffffff"></path>
                    
                    <!-- ⑤【先端チップと胴体の境界線 ──> 後端ノック境界線】美しい対称ディテール線 -->
                    <path d="M 10.27 16.54 L 13.73 14.54 M 16.27 6.15 L 19.73 4.15" stroke="#222222"></path>
                </svg>
            `;
        }
