        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    <!-- ①左上(5,4)から左下(5,18)へ線 ──> 左下(5,18)から90度曲がって、ペン先端との完全なる合流点(13,18)まで伸びる境界線パス -->
                    <path d="M 5 4 L 5 18 L 13 18" stroke-width="2.3"></path>
                    
                    <!-- ②【ペン本体の白抜きアウトライン】先端の尖り(13,18)が、境界線の終点(13,18)へ100%完璧にジャスト重なるように座標を完全計算 -->
                    <path d="M 13 18 L 11.2 15.4 L 18.5 8.1 L 21.1 9.9 L 13.8 17.2 Z" fill="#ffffff"></path>
                    
                    <!-- ③【ペンの先端（チップ）のディテール線】 -->
                    <path d="M 11.2 15.4 L 13.8 17.2" stroke="#222222"></path>
                    
                    <!-- ④【ご指定仕様】ペンの後端付近をななめにカチッと横切る、ノック部を表現したスタイリッシュなディテール線（浮き線は完全撤去） -->
                    <path d="M 18.5 8.1 L 21.1 9.9" stroke="#222222"></path>
                </svg>
            `;
        }
