        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- ②【立体ノックボタン（後端）】中点を完璧に同軸ドッキング。60度方向へ1ミリのブレもなく真っ直ぐ伸びるパーツ -->
                    <path d="M 15.50 6.27 L 16.75 4.10 L 18.48 5.10 L 17.23 7.27 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完全な長方形）】短辺を美しい右肩下がりに保ち、直角90度（内積=0）を満たした白抜きボディ -->
                    <path d="M 9.50 16.08 L 14.50 5.69 L 18.23 7.84 L 13.23 18.23 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】最先端(11.50, 21.00)が境界線の端点へのり、胴体の底辺と隙間なく完璧に融合するチップ -->
                    <path d="M 9.50 16.08 L 11.50 21.00 L 13.23 18.23 Z" fill="#ffffff"></path>
                </svg>
            `;
        }
