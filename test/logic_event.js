        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <path d="M 5 4 L 5 18 L 12.5 18" stroke-width="2.3"></path>
                    
                    <!-- ②【立体ノックボタン（後端）】中心軸に沿って右上へ真っ直ぐ1.25pxの幅で飛び出す、完全対称なノックパーツ -->
                    <path d="M 16.51 3.35 L 17.76 1.18 L 18.84 1.81 L 17.59 3.98 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完全な長方形）】対辺が完全に平行で、1ミリの折れ曲がりも台形化もない白抜きボディ -->
                    <path d="M 9.14 14.54 L 15.14 4.14 L 18.96 1.94 L 12.96 12.34 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】最先端(12.5,18)に向けて左右均等にシャープに絞られるV字チップ -->
                    <path d="M 9.14 14.54 L 12.50 18.00 L 12.96 12.34 Z" fill="#ffffff"></path>
                    
                    <!-- ⑤【先端チップと胴体の境界線 ──> 後端ノック境界線】綺麗な対称ディテール線 -->
                    <path d="M 9.14 14.54 L 12.96 12.34 M 15.14 4.14 L 18.96 1.94" stroke="#222222"></path>
                </svg>
            `;
        }
