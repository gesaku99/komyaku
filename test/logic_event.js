        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- ②【立体ノックボタン（後端）】胴体の中心軸の真上から右上60度へ真っ直ぐ2.00px飛び出す完全同軸パーツ -->
                    <path d="M 16.51 5.31 L 17.51 3.58 L 19.49 2.27 L 18.49 4.00 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完全な長方形）】直角90度（内積=0）と右肩下がりを完璧に満たした、折れ曲がりゼロの美しいボディ -->
                    <path d="M 9.77 18.00 L 15.77 7.60 L 19.23 5.60 L 13.23 16.00 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】最先端(11.50, 21.00)が境界線の端点へのり、胴体底辺と100%隙間なく融合するチップ -->
                    <path d="M 9.77 18.00 L 11.50 21.00 L 13.23 16.00 Z" fill="#ffffff"></path>
                </svg>
            `;
        }
