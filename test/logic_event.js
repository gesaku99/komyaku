        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    <!-- ①左上(5,4)から左下(5,18)、右へ折れ曲がって(12,18)まで引かれた太さ2.3の境界線 -->
                    <path d="M 5 4 L 5 21 L 12 21" stroke-width="2.3"></path>
                    
                    <!-- ②【立体ノックボタン（後端）】胴体の中心軸から60度方向へ真っ直ぐ突き出す完全対称なノックパーツ -->
                    <path d="M 16.5 3.5 L 17.5 1.0 L 18.5 1.5 L 17.5 4.0 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完璧な長方形）】対辺が完全に平行な、1ミリの折れ曲がりもない白抜きボディ -->
                    <path d="M 10.0 16.0 L 15.5 5.5 L 19.5 7.5 L 14.0 15.0 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】最先端(12,21)が、胴体の短辺底辺からブレずに均等に尖るシャープチップ -->
                    <path d="M 10.0 16.0 L 12.0 21.0 L 14.0 15.0 Z" fill="#ffffff"></path>
                    
                    <!-- ⑤【先端チップと胴体の境界線 ──> 後端ノック境界線】美しい対称ディテール線 -->
                    <path d="M 10.0 16.0 L 14.0 15.0 M 15.5 5.5 L 19.5 7.5" stroke="#222222"></path>
                </svg>
            `;
        }
