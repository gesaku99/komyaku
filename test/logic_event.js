        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- ②【立体ノックボタン（後端）】中心軸に沿って右上へ真っ直ぐ飛び出す、ブレのないノックパーツ -->
                    <path d="M 18.25 5.10 L 19.50 2.93 L 20.58 3.56 L 19.33 5.73 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完璧な長方形）】逆方向補正により折れ曲がりが完全消滅した真っ直ぐな白抜きボディ -->
                    <path d="M 10.59 13.91 L 16.59 3.51 L 20.41 5.71 L 14.41 16.11 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】最下部(12.5, 21.0)へ向けて美しく左右均等に尖るシャープチップ -->
                    <path d="M 10.59 13.91 L 12.50 21.00 L 14.41 16.11 Z" fill="#ffffff"></path>
                    
                    <!-- ⑤【先端チップと胴体の境界線 ──> 後端ノック境界線】美しい線対称ディテール線 -->
                    <path d="M 10.59 13.91 L 14.41 16.11 M 16.59 3.51 L 20.41 5.71" stroke="#222222"></path>
                </svg>
            `;
        }
