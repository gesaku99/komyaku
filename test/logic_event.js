        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    <!-- ①左上から左下、右へ折れ曲がる境界線パス（太さ2.3維持） -->
                    <path d="M 5 4 L 5 18 L 12.0 18" stroke-width="2.3"></path>
                    
                    <!-- ②【立体ノックボタン（後端）】中心軸ズレを完全修復！長方形の短辺中央から完璧に同軸で飛び出すパーツ -->
                    <path d="M 16.91 4.15 L 18.16 1.98 L 19.24 2.61 L 17.99 4.78 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完璧な長方形）】現在の美しいバランスをそのままに、下方へスマートに平行移動 -->
                    <path d="M 10.09 14.91 L 16.09 4.51 L 19.91 6.71 L 13.91 17.11 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（完全な二等辺三角形）】胴体の短辺を底辺とし、最下部(12.0, 22.0)へ1本のブレもなく尖る対称チップ -->
                    <path d="M 10.09 14.91 L 12.00 22.00 L 13.91 17.11 Z" fill="#ffffff"></path>
                    
                    <!-- ⑤【先端チップと胴体の境界線 ──> 後端ノック境界線】美しい線対称ディテール線 -->
                    <path d="M 10.09 14.91 L 13.91 17.11 M 16.09 4.51 L 19.91 6.71" stroke="#222222"></path>
                </svg>
            `;
        }
