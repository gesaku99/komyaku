        ...
        if (i === 9) {
            ...
            btn.innerHTML = `
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#222222" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- ②【立体ノックボタン】後端から中心軸に沿って真っ直じゅぐ飛び出す完璧な小長方形パーツ -->
                    <path d="M 18.17 3.59 L 19.42 1.42 L 21.15 2.42 L 19.90 4.59 Z" fill="#333333" stroke="#222222"></path>

                    <!-- ③【ペン胴体部分（完全な長方形）】対辺の長さが1.00000ミリの狂いもなく一致する透過白抜きボディ -->
                    <path d="M 11.17 13.37 L 16.67 3.84 L 20.67 2.84 L 15.17 12.37 Z" fill="#ffffff"></path>
                    
                    <!-- ④【ペン先の三角錐（底辺より長い二等辺三角形）】最先端(13,18)へ向けて完全に左右対称に絞られるV字シャープチップ -->
                    <path d="M 11.17 13.37 L 13.00 18.00 L 15.17 12.37 Z" fill="#ffffff"></path>
                    
                    <!-- ⑤【先端チップと胴体の境界線 ＆ 後端ノック境界線】ディテール補強の平行線 -->
                    <path d="M 11.17 13.37 L 15.17 12.37 M 16.67 3.84 L 20.67 2.84" stroke="#222222"></path>
                </svg>
            `;
        }
